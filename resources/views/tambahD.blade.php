...
<head>
    ...
    <title>Manage Data Table d</title>
</head>

<body>
    <div class="container mt-5">
        <h2>Manage Data for Table d</h2>
        ...
        <form action="{{ route('table_d.store') }}" method="POST">
            @csrf
        ...
        <form action="{{ route('table_d.storeExcel') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
